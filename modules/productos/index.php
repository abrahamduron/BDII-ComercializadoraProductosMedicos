...
// Obtener categorías
$categorias = $db->executeQuery("SELECT * FROM categorias_productos");
...
if ($_POST) {
    ...
    if (isset($_POST['editar_producto'])) {
        $result = $db->executeProcedure("sp_Producto_Actualizar", [
            $_POST['id_producto'],
            $_POST['codigo_producto'],
            $_POST['nombre'],
            $_POST['descripcion'],
    ...
    if (isset($_POST['eliminar_producto'])) {
        $result = $db->executeProcedure("sp_Producto_Eliminar", [$_POST['id_producto']]);
                ...
                <tbody>
                    ...
                    <?php elseif (!empty($productos)): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $producto['categoria_nombre'] ?? 'N/A'; ?></td>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="codigo_producto" class="form-control" 
                               value="<?php echo $producto_editar ? $producto_editar['codigo_producto'] : ''; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Nombre:</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_categoria" class="form-control" required>
                            ...
                            <?php if (!empty($categorias) && !isset($categorias['error'])): ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="stock_minimo" class="form-control" 
                               value="<?php echo $producto_editar ? $producto_editar['stock_minimo'] : '0'; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Precio Compra:</label>
                        <input type="number" name="precio_compra" class="form-control" step="0.01" 
                               value="<?php echo $producto_editar ? $producto_editar['precio_compra'] : '0.00'; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Precio Venta:</label>
                        <input type="number" name="precio_venta" class="form-control" step="0.01" 
                               value="<?php echo $producto_editar ? $producto_editar['precio_venta'] : '0.00'; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Precio Mayorista:</label>
                        <input type="number" name="precio_mayorista" class="form-control" step="0.01" 
                               value="<?php echo $producto_editar ? $producto_editar['precio_mayorista'] : '0.00'; ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label>Descripción:</label>
                    <textarea name="descripcion" class="form-control" rows="3"><?php echo $producto_editar ? $producto_editar['descripcion'] : ''; ?></textarea>
                </div>
                <div class="form-group">
                    <label>
